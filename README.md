...
- 2026-04-12 [v55](https://github.com/zsteinkamp/m4l-Knobbler4/releases/download/v55/Knobbler4-v55.amxd) - Per-instance settings for multi-device support (X-Y pairs and meters state are now independent per device).
