...
- 2026-05-22 [v62](https://github.com/zsteinkamp/m4l-Knobbler4/releases/download/v62/Knobbler4-v62.zip) - Swap or move a slot's mapping to another slot via the new `swap` capability, powering the app's two-phase mapping UI where the picked source pulses green in time with the music while you choose a destination. XY pairs survive a swap (only a move out of a pair splits it). Fix: detach Bluhand cue-point observers before dropping them.
