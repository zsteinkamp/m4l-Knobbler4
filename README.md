...
- 2026-05-22 [v62](https://github.com/zsteinkamp/m4l-Knobbler4/releases/download/v62/Knobbler4-v62.zip) - Swap or move a slot's mapping to another slot via the new `swap` capability, powering the app's two-phase (green source / yellow destination) mapping UI. Fix: detach Bluhand cue-point observers before dropping them.
