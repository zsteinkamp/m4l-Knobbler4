...
exports.OUTLET_LOOP = 3; // 'loop' -> [s ---LOOP]
exports.OUTLET_REFRESH = 4; // 'refresh'/'initMenuOnly' -> [s ---REFRESH_LOGIC]
exports.OUTLET_PAGE = 5; // 'page' <name> -> [s ---PAGE] (page UI)
exports.OUTLET_CONFIGURE = 6; // 'host'/'port' -> [s ---CONFIGURE] ([udpsend] target)
