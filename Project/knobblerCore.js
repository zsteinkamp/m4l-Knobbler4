...
exports.val =
  ...
  exports.setMax =
  exports.setDefault =
  exports.setCustomName =
  exports.refresh =
  exports.initAll =
  exports.gotoTrackFor =
  exports.clearPath =
  exports.clearCustomName =
    void 0
...
function setPath(slot, paramPath) {
  ...
  var testObj = new LiveAPI(function (iargs) {
  ...
  automationStateObj[slot] = new LiveAPI(function (iargs) {
    return automationStateCallback(slot, iargs)
  }, paramPath)
  ...
  deviceCheckerTask[slot] = new Task(function () {
    return checkDevicePresent(slot)
  })
  ...
  // parent name
  parentNameObj[slot] = new LiveAPI(function (iargs) {
    return parentNameCallback(slot, iargs)
  }, parentId)
  parentNameObj[slot].property = 'name'
  param[slot].parentName = parentNameObj[slot].get('name')
  // parent color
  parentColorObj[slot] = new LiveAPI(function (iargs) {
    return parentColorCallback(slot, iargs)
  }, parentId)
...
function sendParamName(slot) {
  ...
  initSlotIfNecessary(slot)
  var paramName = (0, utils_1.dequote)(
    (
  ...
  if (paramObj[slot]) {
    ...
    if (allowMapping[slot]) {
      ...
      if (allowUpdateFromOsc[slot]) {
        ...
        ;(0, utils_1.debouncedTask)(
          'allowUpdateFromOsc',
          slot,
          allowUpdateFromOscTask,
          500
        )
      }
      //log("PRE-SELOBJ\n");
